...
#define encstr cx::make_encrypted_string<CX_ENCSTR_RNGSEED>

#define enc_string cx::encrypted_string
#define encstr_tostr(s) std::string(s)

#define strenc( s ) std::string( encstr( s ) )
#define charenc( s ) strenc( s ).c_str()

#else
#define encstr(s) ( s )

#define enc_string std::string
#define encstr_tostr(s) ( s )
