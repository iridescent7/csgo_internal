...
{
    _rgba[0] = (unsigned char)_r;
    _rgba[1] = (unsigned char)_g;
    _rgba[2] = (unsigned char)_b;
    _rgba[3] = (unsigned char)_a;
}
void Color::SetColor(float _r, float _g, float _b, float _a)
{
    _rgba[0] = static_cast<unsigned char>(_r * 255.0f);
    _rgba[1] = static_cast<unsigned char>(_g * 255.0f);
    _rgba[2] = static_cast<unsigned char>(_b * 255.0f);
    _rgba[3] = static_cast<unsigned char>(_a * 255.0f);
}
