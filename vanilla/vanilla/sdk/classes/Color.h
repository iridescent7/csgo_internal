...
public:
	...
	{
		_rgba[2] = (unsigned char)((argb & 0x000000FF) >> (0 * 8));
		_rgba[1] = (unsigned char)((argb & 0x0000FF00) >> (1 * 8));
		_rgba[0] = (unsigned char)((argb & 0x00FF0000) >> (2 * 8));
		_rgba[3] = (unsigned char)((argb & 0xFF000000) >> (3 * 8));
	}
