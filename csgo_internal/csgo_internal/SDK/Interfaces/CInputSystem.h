...
public:
	void EnableInput(bool enabled)
	{
		...
		return getvfunc<Fn>(this, 11)(this, enabled);
	}

	bool IsButtonDown(int button_code)
	{
		typedef bool(__thiscall* OriginalFn)(void*, int);
		return getvfunc<OriginalFn>(this, 15)(this, button_code);
	}

	const char* ButtonCodeToString(int button_code)
	{
		typedef const char*(__thiscall* OriginalFn)(void*, int);
		return getvfunc<OriginalFn>(this, 40)(this, button_code);
	}
	...
	int ButtonCodeToVirtualKey(int button_code)
	{
		typedef int(__thiscall* OriginalFn)(void*, int);
		return getvfunc<OriginalFn>(this, 45)(this, button_code);
	}

	void GetCursorPosition(int* pX, int* pY)
	{
		typedef void(__thiscall* OriginalFn)(void*, int*, int*);
		return getvfunc<OriginalFn>(this, 56)(this, pX, pY);
	}
};