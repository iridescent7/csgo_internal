...
public:
	...
	virtual void            AddBoxOverlay2(const Vector& origin, const Vector& mins, const Vector& max, Vector const& orientation, const unsigned char* faceColor, const unsigned char* edgeColor, float duration) = 0;
	...
	{
		typedef void(__thiscall* Fn)(void*, Vector&, Vector&, float&, int, int, int, int, float);
		getvfunc<Fn>(this, 23)(this, mins, maxs, pillradius, r, g, b, a, duration);
	}
};
