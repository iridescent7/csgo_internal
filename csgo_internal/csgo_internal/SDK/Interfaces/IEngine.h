...
public:
	...
	virtual bool                  LoadGameLump(int lumpId, void* pBuffer, int RenderStatesLength) = 0;
	...
	virtual void*                 SaveAllocMemory(size_t num, size_t RenderStatesLength) = 0;
	...
	virtual void                  GetStartupImage(char* filename, int RenderStatesLength) = 0;
