...
public:
    ...
    virtual void          DrawTexturedLine(const _Vertex_t &a, const _Vertex_t &b) = 0;
    virtual void          DrawOutlinedCircle(int x, int y, int radius, int segments) = 0;
    virtual void          DrawTexturedPolyLine(const _Vertex_t *p, int n) = 0;
    virtual void          DrawTexturedSubRect(int x0, int y0, int x1, int y1, float texs0, float text0, float texs1, float text1) = 0;
    virtual void          DrawTexturedPolygon(int n, _Vertex_t *pVertice, bool bClipVertices = true) = 0;
	...
	unsigned long CreateSourceFont()
	{
		return getvfunc<unsigned long(__thiscall*)(void*)>(this, 71)(this);
	}

	bool SetFont(unsigned long font, const char* fontName, int tall, int weight, int blur, int scanlines, int flags, int rangeMin = 0, int rangeMax = 0)
	{
		typedef bool(__thiscall *Fn)(void*, unsigned, const char*, int, int, int, int, int, int, int);
		return getvfunc<Fn>(this, 72)(this, font, fontName, tall, weight, blur, scanlines, flags, rangeMin, rangeMax);
	}
